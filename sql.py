...
class SQLInjector:
    ...
    def setup_args(self):
        ...
        parser.add_argument('-w','--wordlist'  , required=False, help="File containing list of SQL commands to test")
        parser.add_argument('-e','--error'     , required=False, help="Error message to identify unsuccessful login")
        parser.add_argument('-uc','--UCSS'     , required=False, help="Error message to identify unsuccessful login")
        parser.add_argument('-pc','--PCSS'     , required=False, help="Error message to identify unsuccessful login")
        parser.add_argument('-ux','--UXpath'   , required=False, action='store',help="Error message to identify unsuccessful login")
        parser.add_argument('-px','--PXpath'   , required=False, action='store',help="Error message to identify unsuccessful login")
        parser.add_argument('-ui','--IDUSER'   , required=False, action='store',help="Error message to identify unsuccessful login")
        parser.add_argument('-pi','--IDPASS'   , required=False, action='store',help="Error message to identify unsuccessful login")
        parser.add_argument('-p','--password'  , required=False, action='store',help="Error message to identify unsuccessful login")
        parser.add_argument('-u','--username'  , required=False, action='store',help="Error message to identify unsuccessful login")
        parser.add_argument('-f','--userforce' , required=False, action='store',help="Error message to identify unsuccessful login")
        parser.add_argument('-C','--Continue'  , required=False, action='store_true',help="Error message to identify unsuccessful login")
        parser.add_argument('-L','--Length'    , required=False, action='store',help="Error message to identify unsuccessful login")
        parser.add_argument('-l','--live'      , required=False, action='store_true',help="Error message to identify unsuccessful login")
        parser.add_argument('-T','--time'      , required=False, action='store',help="Error message to identify unsuccessful login")
